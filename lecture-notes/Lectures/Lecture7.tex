...
\begin{itemize}
    ...
    \item FWHM of a conductance peak can be used to estimate the electron temperature in the device. There is a quantum and classical equation for this.
    ...
    \item Tune QPC to slope between conductance plateaus. Change in charge on dot changes potential landscape and hence conductance of QPC.
    ...
    \item Single-electron turnstile: AC pulse gates at fixed frequency to get current standard $I = ef$. NIST standard: 1 part in $10^8$ which is better than what the turnstiles can do.
    ...
    \item Cotunneling (2nd order perturbation theory): electron tunnels from source to higher level in dot, then to drain.
