...
\begin{itemize}
    ...
    \item Asymmetric coupling: Coulomb staircase \parencite{Matsumoto1996}
    \item Paper example with coulomb diamond \parencite{Thelander2003}
\end{itemize}
...
\begin{itemize}
    \item Paper shows off-set charges in coulomb diamond diagram \parencite{Bolotin2004}
...
\begin{itemize}
    ...
    \item Single-electron logic and memory devices \parencite{Korotkov1999}. Issues: random offset charges, and room temp operation.
    ...
    \item Room temp silicon SET (coulomb diamonds not very reproducible so can't be used in our normal computers) \parencite{Zhang1998}
\end{itemize}
...
\begin{itemize}
    ...
    \item Excited state spectroscopy in carbon nanotube double quantum dots \parencite{Sapmaz2005}
    \item Cotunneling spectroscopy in GaAs quantum dots \parencite{Zumbuhl2004}
\end{itemize}